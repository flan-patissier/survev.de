...
const SkinDefs: Record<string, MeleeDef> = {
    ...
    knuckles_OldMan: defineMeleeSkin("knuckles", {
        ...
        noPotatoSwap: false,
        lootImg: {
            sprite: "loot-melee-knuckles-oldman.img",
        },
        worldImg: {
            sprite: "loot-melee-knuckles-oldman.img",
        },
    ...
    karambit_woodland: defineMeleeSkin("karambit", {
        name: "Karambit Woodland",
        rarity: Rarity.Rare,
        noPotatoSwap: false,
        lootImg: {
            sprite: "loot-melee-karambit-woodland.img",
        },
        worldImg: {
            sprite: "loot-melee-karambit-woodland.img",
        },
    }),
    karambit_rust: defineMeleeSkin("karambit", {
        name: "Karambit Rust",
        rarity: Rarity.Rare,
        noPotatoSwap: false,
        lootImg: {
